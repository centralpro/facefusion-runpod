...
def get_launch_options() -> Dict[str, Any]:
	"""Options for Gradio launch(), e.g. for RunPod (bind 0.0.0.0 and use exposed port)."""
	server_name = os.environ.get('GRADIO_SERVER_NAME', '127.0.0.1')
	server_port = os.environ.get('GRADIO_SERVER_PORT') or os.environ.get('RUNPOD_POD_PORT', '7860')
	try:
...
def build_blocks() -> gradio.Blocks:
	"""Build and return Gradio Blocks without launching (e.g. for mounting in FastAPI)."""
